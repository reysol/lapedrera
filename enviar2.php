...
if ($envio>0){$resultado='Gracias '.$nombre.' el Mensaje se ha enviado...';}else{$resultado='Lo sentimos el Mensaje no se pudo enviar, intente mas tarde o escribanos directamente a jpsollender@gmail.com';}
